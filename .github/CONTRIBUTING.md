...
Our syntax is defined in the [**.editorconfig**](https://github.com/bereft-souls/QuestBooks/blob/main/.editorconfig) file located at the project's root. Most modern IDEs will automatically detect and apply these settings. If your editor does not support `.editorconfig`, the following sections outline the conventions and style used throughout the project.
...
Use expression bodies for methods:

```cs
public static void Execute() => Console.WriteLine("The cake is a lie");
```
